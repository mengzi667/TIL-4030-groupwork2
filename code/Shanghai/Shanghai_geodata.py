...
grid = grid.to_crs(epsg=4326)
grid.to_csv('data/Shanghai/grid_with_counts_landuse.csv', index=False)
print("Grid with landuse areas saved to 'data/Shanghai/grid_with_counts_landuse.csv'")
...
print("Updated grid with landuse areas saved to 'data/Shanghai/grid_with_counts.csv'")